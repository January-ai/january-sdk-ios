...
* Native Swift 6.1 package for iOS 15+
...
During Controlled Preview, pin the verified revision documented on [Installation](../getting-started/installation.md) and review changes before updating.
